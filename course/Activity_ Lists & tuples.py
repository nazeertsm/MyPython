...
# 2. ### YOUR CODE HERE ###
is_same = state_county_zipped == state_county_tuples

state_county_zipped, is_same
...
### YOUR CODE HERE ###
# Unpacking each tuple in state_county_tuples and adding counties in California to a list called ca_counties
